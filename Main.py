...
# "C:\Users\Atharv Kothari\KneeBendVideo.mp4"
...
# cap = cv2.VideoCapture('C:/Users/Atharv Kothari/KneeBendVideo.mp4')
...
text_speech.say("hello "+name+" what body part you want to do excercise of :")
text_speech.runAndWait()
...
text_speech.say("do have a good excercise session "+name)
text_speech.runAndWait()
